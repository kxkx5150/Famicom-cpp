...
class Ppu {
  ...
  private:
    ...
    uint64_t ppu_addr_buffer  = 0;
    uint64_t h_scroll_val     = 0;
    bool     ppu_addr_reg_flg = false;
    uint64_t ppu_addr         = 0;
    uint64_t ppu_read_buffer  = 0;
  ...
  public:
    ...
    void      set_chr_rom_page(uint64_t num);
  ...
  private:
    ...
    void init_mirrors(uint64_t value0, uint64_t value1, uint64_t value2, uint64_t value3);
    void set_chr_rom_data1k(uint64_t page, uint64_t romPage);
    void set_chrrom_pages1k(uint64_t rompage0, uint64_t rompage1, uint64_t rompage2, uint64_t rompage3,
    ...
    void    in_vblank();
    void    post_render();
    void    set_img_data(uint8_t r, uint8_t g, uint8_t b);
